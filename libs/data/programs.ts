...
export const allPrograms: Program[] = [
	{ id: '1', name: 'Alpha Muscle Builder', type: 'MASS GAIN', level: 'ADVANCED', duration: 12, price: 49, views: 8400, likes: 342, members: 1240, rating: 4.7, gradient: 'linear-gradient(160deg, #1a0a0a 0%, #3d1212 100%)' },
	{ id: '2', name: 'Fat Torch Express', type: 'WEIGHT LOSS', level: 'BEGINNER', duration: 8, price: 29, views: 7200, likes: 289, members: 980, rating: 4.6, gradient: 'linear-gradient(160deg, #0a1a0a 0%, #123d12 100%)' },
	{ id: '3', name: 'Power Lift Fundamentals', type: 'STRENGTH', level: 'INTERMEDIATE', duration: 10, price: 39, views: 6100, likes: 256, members: 870, rating: 4.8, gradient: 'linear-gradient(160deg, #0a0a1a 0%, #12123d 100%)' },
	{ id: '4', name: 'HIIT Cardio Blast', type: 'CARDIO', level: 'BEGINNER', duration: 6, price: 19, views: 9800, likes: 234, members: 1560, rating: 4.5, gradient: 'linear-gradient(160deg, #1a0a1a 0%, #3d123d 100%)' },
	{ id: '5', name: 'Zen Flow Yoga', type: 'YOGA', level: 'BEGINNER', duration: 8, price: 25, views: 5300, likes: 198, members: 720, rating: 4.9, gradient: 'linear-gradient(160deg, #0a1a1a 0%, #123d3d 100%)' },
	{ id: '6', name: 'Athletic Movement Lab', type: 'FUNCTIONAL', level: 'INTERMEDIATE', duration: 10, price: 35, views: 4800, likes: 187, members: 640, rating: 4.6, gradient: 'linear-gradient(160deg, #1a1a0a 0%, #3d3d12 100%)' },
	{ id: '7', name: 'Comeback Program', type: 'REHABILITATION', level: 'BEGINNER', duration: 6, price: 45, views: 3200, likes: 156, members: 430, rating: 4.8, gradient: 'linear-gradient(160deg, #1a0f0a 0%, #3d2512 100%)' },
	{ id: '8', name: 'Mobility & Flexibility Pro', type: 'MOBILITY', level: 'INTERMEDIATE', duration: 8, price: 30, views: 2900, likes: 145, members: 510, rating: 4.7, gradient: 'linear-gradient(160deg, #0f0a1a 0%, #25123d 100%)' },
	{ id: '9', name: 'Elite Mass Protocol', type: 'MASS GAIN', level: 'ADVANCED', duration: 16, price: 89, views: 18400, likes: 920, members: 3100, rating: 4.9, gradient: 'linear-gradient(160deg, #1a0505 0%, #3d0f0f 100%)' },
	{ id: '10', name: 'Total Body Transformation', type: 'FUNCTIONAL', level: 'INTERMEDIATE', duration: 12, price: 69, views: 15200, likes: 740, members: 2600, rating: 4.8, gradient: 'linear-gradient(160deg, #050a1a 0%, #0f1a3d 100%)' },
	{ id: '11', name: 'Olympic Strength Base', type: 'STRENGTH', level: 'ADVANCED', duration: 20, price: 99, views: 13800, likes: 680, members: 2200, rating: 4.9, gradient: 'linear-gradient(160deg, #0a0a0a 0%, #1f1f1f 100%)' },
	{ id: '12', name: 'Rapid Fat Loss System', type: 'WEIGHT LOSS', level: 'INTERMEDIATE', duration: 8, price: 49, views: 11600, likes: 590, members: 1950, rating: 4.7, gradient: 'linear-gradient(160deg, #0a1a05 0%, #1a3d0f 100%)' },
	{ id: '13', name: 'Advanced Yoga & Breath', type: 'YOGA', level: 'ADVANCED', duration: 10, price: 55, views: 9200, likes: 480, members: 1400, rating: 4.8, gradient: 'linear-gradient(160deg, #05101a 0%, #0f203d 100%)' },
	{ id: '14', name: 'Recovery & Rebuild', type: 'REHABILITATION', level: 'BEGINNER', duration: 6, price: 39, views: 7800, likes: 430, members: 1100, rating: 4.9, gradient: 'linear-gradient(160deg, #1a1005 0%, #3d250f 100%)' },
	{ id: '15', name: 'Sport Performance Edge', type: 'FUNCTIONAL', level: 'ADVANCED', duration: 14, price: 75, views: 6400, likes: 360, members: 890, rating: 4.7, gradient: 'linear-gradient(160deg, #100a1a 0%, #1a123d 100%)' },
	{ id: '16', name: 'Beginner Blueprint', type: 'STRENGTH', level: 'BEGINNER', duration: 8, price: 0, views: 14600, likes: 820, members: 4200, rating: 4.8, gradient: 'linear-gradient(160deg, #0a0a1a 0%, #151530 100%)' },
	{ id: '17', name: 'The 6-Week Shred', type: 'WEIGHT LOSS', level: 'INTERMEDIATE', duration: 6, price: 34, views: 12400, likes: 520, members: 2100, rating: 4.6, gradient: 'linear-gradient(160deg, #0a1a0a 0%, #1a3d1a 100%)' },
	{ id: '18', name: 'Morning Mobility Flow', type: 'MOBILITY', level: 'BEGINNER', duration: 4, price: 0, views: 8900, likes: 760, members: 4100, rating: 4.9, gradient: 'linear-gradient(160deg, #0a1a1a 0%, #1a2d2d 100%)' },
	{ id: '19', name: 'Powerlifting Prep', type: 'STRENGTH', level: 'ADVANCED', duration: 16, price: 79, views: 7800, likes: 290, members: 890, rating: 4.7, gradient: 'linear-gradient(160deg, #1a1a0a 0%, #2d2d1a 100%)' },
	{ id: '20', name: 'Cardio Kickstarter', type: 'CARDIO', level: 'BEGINNER', duration: 4, price: 15, views: 7200, likes: 540, members: 2780, rating: 4.5, gradient: 'linear-gradient(160deg, #1a0a1a 0%, #2d1a2d 100%)' },
	{ id: '21', name: 'Yoga for Athletes', type: 'YOGA', level: 'INTERMEDIATE', duration: 6, price: 29, views: 6500, likes: 330, members: 1230, rating: 4.6, gradient: 'linear-gradient(160deg, #0f1a0a 0%, #1a2d12 100%)' },
	{ id: '22', name: 'Beginner Strength Foundation', type: 'STRENGTH', level: 'BEGINNER', duration: 8, price: 0, views: 10800, likes: 680, members: 3200, rating: 4.8, gradient: 'linear-gradient(160deg, #0a0a1a 0%, #1a1a3d 100%)' },
];
